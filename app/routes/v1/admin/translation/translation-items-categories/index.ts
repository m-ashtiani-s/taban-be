...
translationItemsCategoriesRouter.get("/:translationItemCategoryId", TranslationItemCategoryValidation.translationItemCategoryId, translationItemCategoryAdminController.getTranslationItemCategory);
...
translationItemsCategoriesRouter.put("/:translationItemCategoryId", TranslationItemCategoryValidation.translationItemCategoryId, TranslationItemCategoryValidation.updateTranslationItemCategory, translationItemCategoryAdminController.updateTranslationItemCategory);
translationItemsCategoriesRouter.delete("/:translationItemCategoryId", TranslationItemCategoryValidation.translationItemCategoryId, translationItemCategoryAdminController.deleteTranslationItemCategory);
